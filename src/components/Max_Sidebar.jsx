  ...
  return (
	...
	<div class="flex flex-col items-center w-40 h-full overflow-hidden text-indigo-300 bg-indigo-900 rounded">
		<a class="flex items-center w-full px-3 mt-3" href="#">
			...
			<span class="ml-2 text-sm font-bold">LoFi</span>
		</a>
		<div class="w-full px-2">
			<div class="flex flex-col items-center w-full mt-3 border-t border-gray-700">
				<a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-700" href="#">
					...
					<span class="ml-2 text-sm font-medium">Play</span>
				</a>
			</div>
			<div class="flex flex-col items-center w-full mt-2 border-t border-gray-700">
				<a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-700" href="#">
					...
					<span class="ml-2 text-sm font-medium">Themes</span>
				</a>
			</div>
			<div class="flex flex-col items-center w-full mt-2 border-t border-gray-700">
				<a class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-700" href="#">
					...
					<span class="ml-2 text-sm font-medium">White Noise</span>
				</a>
			</div>
		</div>
